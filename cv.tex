...
\cventry{06.2011--08.2011}{\summerintern}{Soleno Oy}{Oulu}{}{
  \IfLanguageName{finnish}{
    ...
    My assignments included development and maintenance of clients' web pages, development and documentation of a Drupal REST plugin, and developing new features for a company internal program written in Visual Basic.
  }
}
\cventry{06.2009--08.2009}{\summerintern}{Identoi Oy}{Oulu}{}{
  \IfLanguageName{finnish}{
    ...
    My assignments were configuring an RFID enabled kiosk computer, and testing a Windows Mobile application the company was developing.
  }
}
